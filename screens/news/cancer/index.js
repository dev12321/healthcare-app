...
class NHListAvatar extends Component {
  ...
  componentDidMount() {
    if (this.state.data.length === 1) {
      ...
      // let base_url = 'http://192.168.133.1:5000/cancer';
      // let base_url = 'http://10.0.2.2:5000/cancer';
      // let base_url = 'http://jayjain-58805.portmap.io:58805/cancer';
      let base_url =
        'http://ec2-3-22-99-96.us-east-2.compute.amazonaws.com/cancer';
      fetch(base_url, {
        method: 'GET',
      })
